...
/**
  ...
  Smart Grain Coin - revolutionary token
  
  https://smartgraincoin.io
  https://t.me/smart_grain
  info@smartgraincoin.io

  Smart Grain Coin features:
...
contract SGC is Context, IERC20, Ownable {
    ...
    string private _name = "Smart Grain Coin";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**2 * 10**18;
